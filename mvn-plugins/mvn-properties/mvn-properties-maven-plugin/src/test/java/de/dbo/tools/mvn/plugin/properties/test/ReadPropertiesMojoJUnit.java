...
public class ReadPropertiesMojoJUnit extends AbstractMojoTestCase {
    private static final Logger log = LoggerFactory.getLogger(ReadPropertiesMojoJUnit.class);
    ...
    public ReadPropertiesMojoJUnit() {
	...
	assertEquals("0.0.0-SNAPSHOT", properties.getProperty("dbo.version", null));
	assertEquals("5.1.6", properties.getProperty("mysql.version", null));
    }
